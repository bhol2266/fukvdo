    ...
    return (
        ...
        <div className={`xl:px-[150px] 2xl:px-[250px] font-footer p-8 sm:px-[70px] mx-auto bg-semiblack  ${spinnerLoading ? "hidden" : ""}  mt-10 text-white select-none`}>
            ...
            <Link href='/membership'>
                <button className="text-white lg:hidden bg-theme_yellow text-semiblack rounded-[22px] font-inter text-center mb-8 mt-4 px-[70px] p-3 m-1 text-sm block_popunder hover:scale-105 transition-transform duration-300 mx-auto block">
                    GET MEMBERSHIP
                </button>
            </Link>
            ...
            <div className='lg:flex justify-start '>
                ...
                <div className='lg:ml-[120px] xl:ml-[200px]'>
                    <p className='text-white font-light text-[16px] text-left my-3 lg:text-[18px]'>FuckVideo Originals exclusive content</p>
            ...
            <Link href='/membership'>
                <button className="text-white lg:block bg-theme_yellow text-gray-100 rounded-[22px] font-inter text-center mb-8 mt-4 px-[70px] p-3 m-1 text-md block_popunder hover:scale-105 transition-transform duration-300 hidden">
                    GET MEMBERSHIP
                </button>
            </Link>
            ...
            <p className='text-sm sm:text-md md:text-lg text-[#AEABAB] mt-8'>2021-2024 FuckVideo.live</p>
