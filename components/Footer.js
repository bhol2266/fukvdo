    ...
    return (
        ...
        <div className={`xl:px-[150px] 2xl:px-[250px] font-footer p-8 sm:px-[70px] mx-auto bg-semiblack  ${spinnerLoading ? "hidden" : ""}  mt-10 text-white select-none`}>
            ...
            <Link href='/membership'>
                <button className="text-white lg:hidden bg-theme_red text-semiblack rounded-[22px] font-inter text-center mb-8 mt-4 px-[70px] p-3 m-1 text-sm block_popunder hover:scale-105 transition-transform duration-300 mx-auto block">
                    GET MEMBERSHIP
                </button>
            </Link>
            ...
            <Link href='/membership'>
                <button className="text-white lg:block bg-theme_red text-gray-100 rounded-[22px] font-inter text-center mb-8 mt-4 px-[70px] p-3 m-1 text-md block_popunder hover:scale-105 transition-transform duration-300 hidden">
                    GET MEMBERSHIP
                </button>
            </Link>
