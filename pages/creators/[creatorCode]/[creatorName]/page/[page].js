    ...
    return (
        <>
            ...
            <Head>
                ...
                <meta property="og:title" content={`${capitalizeFirstLetter(creatorData.creatorName.replace('+', " ").replace("+", " "))} Porn Videos - FuckVideo`} />
                ...
                <meta name="twitter:title" content={`${capitalizeFirstLetter(creatorData.creatorName.replace('+', " ").replace("+", " "))} Porn Videos - FuckVideo`} />
                ...
                <link rel="canonical" href={`https://www.FuckVideo.live/channels/${creatorName}/${creatorCode}`} />
